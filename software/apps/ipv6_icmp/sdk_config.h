 ...
 *                            trace is observed even if this define is set to 1.
 */
#define IOT_PBUFFER_DISABLE_LOGS                           0
 ...
 *                            trace is observed even if this define is set to 1.
 */
#define IOT_CONTEXT_MANAGER_DISABLE_LOGS                    0
